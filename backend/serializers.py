...
from .models import User, Contact, Shop, Category, Product, ProductParameter, Order, OrderItem
...
class OrderItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OrderItem
        fields = ('id', 'product_name', 'external_id', 'quantity', 'price', 'total_amount', 'order', 'category', 'shop')
        read_only_fields = ('id',)
        extra_kwargs = {
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ('id', 'status', 'total_quantity', 'total_sum', 'contact', 'ordered_items')
        read_only_fields = ('id',)
